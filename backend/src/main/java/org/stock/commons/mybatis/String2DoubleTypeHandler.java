 ...
 * under the License.
 */
package org.stock.commons.mybatis;
...
/**
 * Mybatis中将double转换为long类型
 * 
 * <p>
 * <a href="String2DoubleTypeHandler.java"><i>View Source</i></a>
 * 
 * @author zhaoxunyong@qq.com
 * @version 1.0
 * @since 1.0
 */
public class String2DoubleTypeHandler implements TypeHandler<String> {
    ...
    public String getResult(ResultSet arg0, String arg1) throws SQLException {
        double value = arg0.getDouble(arg1);
    ...
    public void setParameter(PreparedStatement arg0, int arg1, String arg2, JdbcType arg3) throws SQLException {
        if (!Strings.isNullOrEmpty(arg2)) {
            double value = Double.parseDouble((String) arg2);
            arg0.setDouble(arg1, value);
        } else {
