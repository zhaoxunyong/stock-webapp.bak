...
function stockVol_getData(datasets, kineType) {
    ...
    return {
        ...
        tooltip: {
            ...
            // extraCssText:'width:100px;height:60px;',
            formatter: function formatter(params) {
                var v = '<font color="' + STOCK_CONFIG.col.up + '">\u6210\u4EA4\u91CF</font> ' + params[0].value;
...
function stockRsi_getData(datasets, kineType) {
    ...
    return {
        ...
        tooltip: {
            ...
            // extraCssText:'width:100px;height:60px;',
            formatter: function formatter(params) {
                var v = '<font color="' + STOCK_CONFIG.col.up + '">RSI-12</font> ' + params[0].value + '\n                <font color="' + STOCK_CONFIG.col.down + '">RSI-100</font> ' + params[0].value;
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-2a3ddb06","hasScoped":true,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/page/kCandle.vue
...
/* scopeId */
var kCandle___vue_scopeId__ = "data-v-2a3ddb06"
/* moduleIdentifier (server only) */
