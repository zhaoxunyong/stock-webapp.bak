...
// CONCATENATED MODULE: ./src/data/stockUtils.js
...
var stockCandle_BB = __webpack_require__("k4Xa").BollingerBands;
var stockCandle_RSI = __webpack_require__("k4Xa").RSI;
var stockCandle_ADX = __webpack_require__("k4Xa").ADX;

var stockCandle_PERIOD = -88;

function stockCandle_getData(datasets, kDisplay) {
    ...
    var bolls = stockCandle_BB.calculate(inputBoll);
    ...
    var rsi12 = stockCandle_RSI.calculate(inputRSI12);

    var inputRSI100 = {
        values: getCloses(datas),
        period: 100
    };
    var rsi100 = stockCandle_RSI.calculate(inputRSI100);
    ...
    var dmis = stockCandle_ADX.calculate(inputDMI);
    ...
    getData: function getData() {
      ...
      if (this.stockId != undefined && this.stockId != '' && this.stockId != 0) {
        ...
        this.$api.get(url, null, function (rs) {
          ...
          _this.stockCandle = stockCandle_getData(datas, '日');
        });
      }
    }
  },
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-3b59963c","hasScoped":true,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/page/kCandle.vue
var kCandle_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('chart',{attrs:{"options":_vm.stockCandle,"auto-resize":_vm.resize},on:{"click":_vm.openNewKline}})],1)}
...
/* scopeId */
var kCandle___vue_scopeId__ = "data-v-3b59963c"
/* moduleIdentifier (server only) */
