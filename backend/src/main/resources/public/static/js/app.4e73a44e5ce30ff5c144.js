...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-36f4db44","hasScoped":true,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/page/StockMyData.vue
...
/* scopeId */
var StockMyData___vue_scopeId__ = "data-v-36f4db44"
/* moduleIdentifier (server only) */
  ...
  methods: {
    ...
    chartInit: function chartInit() {
      ...
      for (var i = 0; i < this.items.length; i++) {
        ...
        var _el = document.getElementById('myChart' + type + '' + this.kineType);
        var chart = this.$echarts.init(_el);
        chartArray.push({
          type: type,
          chart: chart
        });
...
/* scopeId */
var kCandle___vue_scopeId__ = "data-v-23eb32bf"
/* moduleIdentifier (server only) */
