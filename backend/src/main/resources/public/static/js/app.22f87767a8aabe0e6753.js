...
// CONCATENATED MODULE: ./src/data/MACD.js
...
// CONCATENATED MODULE: ./src/data/candlestick.js
...
function candlestick_getData(datasets, kDisplay) {
    ...
    var difs = DIF(datas.values);
    var deas = DEA(datas.values, 9);
    var macds = BAR(datas.values);
    ...
    var rsi12 = RSI.calculate(inputRSI12);

    var inputRSI100 = {
        values: getCloses(datas),
        period: 100
    };
    var rsi100 = RSI.calculate(inputRSI100);
    ...
    return {
        ...
        tooltip: {
            ...
            /* formatter: function (params) {
                ...
                收 ${getSeriesIndex(params,0).data[1]} 
                開 ${getSeriesIndex(params,0).data[0]} 
                高 ${getSeriesIndex(params,0).data[3]} 
                低 ${getSeriesIndex(params,0).data[2]} <br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ${kDisplay}線 
                <font color="${config.col.m5}">M5 ${getSeriesIndex(params,1).value}</font> 
                <font color="${config.col.m10}">M10 ${getSeriesIndex(params,2).value}</font> 
                <font color="${config.col.m20}">M20 ${getSeriesIndex(params,3).value}</font> 
                <font color="${config.col.m60}">M60 ${getSeriesIndex(params,4).value}</font>`
        ...
        xAxis: [{
            ...
            axisLabel: {
                ...
                formatter: function formatter(value) {
                    return echarts_default.a.format.formatTime('MM/dd', value.replace('/', '-'));
                }
            }
        }, {
            type: 'category',
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/page/kDay.vue
//
//
//
//
...
/* harmony default export */ var kDay = ({
  components: {
    // MainLayout//, Alert
  },
  data: function data() {
  ...
  methods: {
    openNewKline: function openNewKline(params) {
        ...
        this.$api.get(url, null, function (rs) {
          if (rs != undefined && rs.length > 0) {
            for (var i = 0; i < rs.length; i++) {
              ...
              var stockHistorys = [rs[i].date, rs[i].opening, rs[i].closing, rs[i].lowest, rs[i].highest, rs[i].vol];
          ...
          _this.kline = candlestick_getData(datas, '日');
        });
      }
    }
  },
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-3e4880e6","hasScoped":true,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/page/kDay.vue
var kDay_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('chart',{attrs:{"options":_vm.kline,"auto-resize":_vm.resize},on:{"click":_vm.openNewKline}})],1)}
var kDay_staticRenderFns = []
var kDay_esExports = { render: kDay_render, staticRenderFns: kDay_staticRenderFns }
/* harmony default export */ var page_kDay = (kDay_esExports);
// CONCATENATED MODULE: ./src/page/kDay.vue
function kDay_injectStyle (ssrContext) {
  __webpack_require__("g//0")
}
var kDay_normalizeComponent = __webpack_require__("VU/8")
/* script */
...
/* template functional */
var kDay___vue_template_functional__ = false
/* styles */
var kDay___vue_styles__ = kDay_injectStyle
/* scopeId */
var kDay___vue_scopeId__ = "data-v-3e4880e6"
/* moduleIdentifier (server only) */
var kDay___vue_module_identifier__ = null
var kDay_Component = kDay_normalizeComponent(
  kDay,
  page_kDay,
  kDay___vue_template_functional__,
  kDay___vue_styles__,
  kDay___vue_scopeId__,
  kDay___vue_module_identifier__
)

/* harmony default export */ var src_page_kDay = (kDay_Component.exports);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/page/kWeek.vue
//
//
//
//
...
/* harmony default export */ var kWeek = ({
  components: {
    // MainLayout//, Alert
  },
  data: function data() {
  ...
  methods: {
    ...
    getData: function getData() {
      ...
      if (this.stockId != undefined && this.stockId != '' && this.stockId != 0) {
        ...
        var url = '/api/stock/selectLastWeekHistory?stockId=' + this.stockId;
        ...
        this.$api.get(url, null, function (rs) {
          ...
          _this.kline = candlestick_getData(datas, '周');
        });
      }
    }
  },
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-007e5961","hasScoped":true,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/page/kWeek.vue
var kWeek_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('chart',{attrs:{"options":_vm.kline,"auto-resize":_vm.resize},on:{"click":_vm.openNewKline}})],1)}
var kWeek_staticRenderFns = []
var kWeek_esExports = { render: kWeek_render, staticRenderFns: kWeek_staticRenderFns }
/* harmony default export */ var page_kWeek = (kWeek_esExports);
// CONCATENATED MODULE: ./src/page/kWeek.vue
function kWeek_injectStyle (ssrContext) {
  __webpack_require__("vxfi")
}
var kWeek_normalizeComponent = __webpack_require__("VU/8")
/* script */
...
/* template functional */
var kWeek___vue_template_functional__ = false
/* styles */
var kWeek___vue_styles__ = kWeek_injectStyle
/* scopeId */
var kWeek___vue_scopeId__ = "data-v-007e5961"
/* moduleIdentifier (server only) */
var kWeek___vue_module_identifier__ = null
var kWeek_Component = kWeek_normalizeComponent(
  kWeek,
  page_kWeek,
  kWeek___vue_template_functional__,
  kWeek___vue_styles__,
  kWeek___vue_scopeId__,
  kWeek___vue_module_identifier__
)

/* harmony default export */ var src_page_kWeek = (kWeek_Component.exports);
...
/* harmony default export */ var stockKLineChart = ({
  components: {
    KDay: src_page_kDay, KWeek: src_page_kWeek /* , RsiDay, RsiWeek, DmiDay, DmiWeek, MacdDay, MacdWeek */
  },
  data: function data() {
    return {};
  },
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-c36f09d6","hasScoped":true,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/page/stockKLineChart.vue
var stockKLineChart_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('b-row',[_c('b-col',{attrs:{"cols":"12","sm":"12"}},[_c('b-row',[_c('b-col',{staticClass:"p-0 m-0 mw-100"},[_c('KDay')],1),_vm._v(" "),_c('b-col',{staticClass:"p-0 m-0 mw-100"},[_c('KWeek')],1)],1)],1)],1)}
...
/* scopeId */
var stockKLineChart___vue_scopeId__ = "data-v-c36f09d6"
/* moduleIdentifier (server only) */
...
/* harmony default export */ var router = (new vue_router_esm["a" /* default */]({
  ...
  routes: [{
    ...
    path: '/kday',
    component: src_page_kDay
  }, {
    path: '/kweek',
    component: src_page_kWeek /* ,
                     {
                      path: '/rsiday',
                      component: RsiDay
                     },
...
// EXTERNAL MODULE: ./node_modules/vue-echarts/dist/vue-echarts.js
var vue_echarts = __webpack_require__("cs+8");
var vue_echarts_default = /*#__PURE__*/__webpack_require__.n(vue_echarts);
...
vue_esm["default"].component('chart', vue_echarts_default.a);
